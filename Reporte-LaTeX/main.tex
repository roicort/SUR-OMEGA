...
\input{Reporte-LaTeX/content/chapter-internacional}   % INCLUDE: state of the art
\input{Reporte-LaTeX/content/chapter-nacional}
%\part{Exemplo doutra parte}
\input{content/chapter-model}         % INCLUDE: model
%\input{content/chapter-results}       % INCLUDE: results
